                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                              ...
                              <div class="col-md-12 mb-3">
                               ...
                               <textarea name="content" class="form-control summernote" rows="5">{!! $page->content !!}</textarea>
                                @error('content')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <textarea name="seo_description" class="form-control summernote" rows="5">{!! $page->seo_description !!}</textarea>
                            ...
                            <!-- Status Field -->
                               ...
                               <div class="col-md-6 mb-3">
                                ...
                                <select name="show_at_nav" class="form-select">
                                    ...
                                    <option value="yes" @selected($page->show_at_nav == 'yes')>Yes</option>
                                    <option value="no" @selected($page->show_at_nav == 'no')>No</option>
                                </select>
                                @error('show_at_nav')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
