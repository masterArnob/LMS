...
<head>
   ...
   {{-- 
    ...
    <link href="{{ asset('admin/dist/css/tabler.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('admin/dist/css/tabler-flags.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('admin/dist/css/tabler-payments.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('admin/dist/css/tabler-vendors.rtl.min.css?1692870487') }}" rel="stylesheet"/>
    <link href="{{ asset('admin/dist/css/demo.rtl.min.css?1692870487') }}" rel="stylesheet"/>
        <style>
