              ...
              <li class="nav-item {{ sidebarItemActive(['admin.dashboard']) }}">
                <a class="nav-link" href="{{ route('admin.dashboard') }}" >
                  ...
                  <span class="nav-link-title">
                    Dashboard
                      ...
                      <li class="nav-item dropdown {{ sidebarItemActive(['admin.instructor-requests.*', 'admin.payout.*', 'admin.payout-request.*']) }}">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    ...
                    <a class="dropdown-item {{ sidebarItemActive(['admin.instructor-requests.*']) }}" href="{{ route('admin.instructor-requests.index') }}">
                        Instructor Requests
                      </a>

                      <a class="dropdown-item {{ sidebarItemActive(['admin.payout.*']) }}" href="{{ route('admin.payout.index') }}">
                        Payout Gateways
                      </a>


                        <a class="dropdown-item {{ sidebarItemActive(['admin.payout-request.*']) }}" href="{{ route('admin.payout-request.index') }}">
                        Payout Requests
                      </a>
                    ...
                    <a class="dropdown-item {{ sidebarItemActive(['admin.course-lang.*']) }}" href="{{ route('admin.course-lang.index') }}">
                      ...
                      <a class="dropdown-item {{ sidebarItemActive(['admin.course-level.*']) }}" href="{{ route('admin.course-level.index') }}">
                        ...
                        Courses
                          ...
                          <li class="nav-item dropdown {{ sidebarItemActive(['admin.opbar-section.*', 'admin.hero-section.*', 'admin.features.*', 'admin.about-section.*', 'admin.news-letter.*', 'admin.become-instructor-section.*', 'admin.video-section.*', 'admin.brand.*', 'admin.testimonials.*', 'admin.footer.*', 'admin.footer-col-one.*', 'admin.footer-col-two.*', 'admin.footer-social-links.*', 'admin.latest-course.*']) }}">
                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5" /><path d="M12 12l8 -4.5" /><path d="M12 12l0 9" /><path d="M12 12l-8 -4.5" /><path d="M16 5.25l-8 4.5" /></svg>
                  </span>
                    ...
                    <a class="dropdown-item {{ sidebarItemActive(['admin.hero-section.*']) }}" href="{{ route('admin.hero-section.index') }}">
                      ...
                      <a class="dropdown-item {{ sidebarItemActive(['admin.features.*']) }}" href="{{ route('admin.features.index') }}">
                        ...
                        About Section
                            ...
                            <a class="dropdown-item {{ sidebarItemActive(['admin.latest-course.*']) }}" href="{{ route('admin.latest-course.index') }}">
                       ...
                       Trusted Brands Section
                         ...
                         <a class="dropdown-item {{ sidebarItemActive(['admin.testimonials.*']) }}" href="{{ route('admin.testimonials.index') }}">
                       Testimonials Section
                      </a>


                          <a class="dropdown-item {{ sidebarItemActive(['admin.footer.*', 'admin.footer-col-one.*', 'admin.footer-col-two.*', 'admin.footer-social-links.*']) }}" href="{{ route('admin.footer.index') }}">
                        Footer Section
                      </a>
                           ...
                           <li class="nav-item dropdown {{ sidebarItemActive(['admin.about-page.*', 'admin.contact-us-page']) }}">
                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5" /><path d="M12 12l8 -4.5" /><path d="M12 12l0 9" /><path d="M12 12l-8 -4.5" /><path d="M16 5.25l-8 4.5" /></svg>
                  </span>
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                        <a class="dropdown-item {{ sidebarItemActive(['admin.about-page.*']) }}" href="{{ route('admin.about-page.index') }}">
                        About Page 
                      </a>

                          <a class="dropdown-item {{ sidebarItemActive(['admin.contact-us-page.*']) }}" href="{{ route('admin.contact-us-page.index') }}">
                        Contact Us Page 
                      </a>
                ...
                <a class="nav-link {{ sidebarItemActive(['admin.orders.*']) }}" href="{{ route('admin.orders.index') }}" >
                 ...
                 <li class="nav-item {{ sidebarItemActive(['admin.custom-page-builder.*']) }}">
                <a class="nav-link" href="{{ route('admin.custom-page-builder.index') }}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 12l-2 0l9 -9l9 9l-2 0" /><path d="M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" /><path d="M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" /></svg>
                  </span>
                  <span class="nav-link-title">
                    Custom Page Builder
                          ...
                          <li class="nav-item dropdown {{ sidebarItemActive(['admin.payment-settings.*', 'admin.general-settings.*', 'admin.logo-settings.*', 'admin.comission-settings.*', 'admin.smtp-settings.*']) }}">
                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="false" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 3l8 4.5l0 9l-8 4.5l-8 -4.5l0 -9l8 -4.5" /><path d="M12 12l8 -4.5" /><path d="M12 12l0 9" /><path d="M12 12l-8 -4.5" /><path d="M16 5.25l-8 4.5" /></svg>
                  </span>
                  ...
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                        ...
                        Payment Settings 
                          ...
                          <a class="dropdown-item {{ sidebarItemActive(['admin.general-settings.*', 'admin.logo-settings.*', 'admin.comission-settings.*', 'admin.smtp-settings.*']) }}" href="{{ route('admin.general-settings.index') }}">
                        Site Settings 
                      </a>
