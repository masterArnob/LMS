        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <div class="col-auto">
                    <a href="{{ route('admin.course-lang.create') }}" class="btn btn-primary">
                        Create New
                    </a>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('admin.course-lang.edit', $lang->id) }}" class="btn btn-icon" aria-label="Edit">
                                                ...
                                                <a href="{{ route('admin.course-lang.destroy', $lang->id) }}" class="delete-item btn btn-icon" aria-label="Delete" data-bs-toggle="modal" data-bs-target="#modal-danger">
