                            ...
                            <tbody>
                             ...
                             @forelse ($courses as $course)
                                    <tr>
                                       ...
                                       <td>   <img src="{{ asset($course->thumbnail) }}" alt="{{ $course->title }}" class="" width="150" height="100" style="object-fit: cover;"></td>
                                    ...
                                    <td>
                                            ...
                                            @elseif ($course->status == 'inactive')
                                              ...
                                              <span class="badge badge-outline text-orange">Draft</span>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('admin.course.edit', $course->id) }}" class="btn btn-icon" aria-label="Edit">
                                                ...
                                                <a href="{{ route('admin.course.destroy', $course->id) }}" class="delete-item btn btn-icon" aria-label="Delete" data-bs-toggle="modal" data-bs-target="#modal-danger">
