...
@section('settings-content')
      <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('admin.footer-col-one.create') }}" class="btn btn-primary">Create New</a>
      </div>
                                    ...
                                    <td><a href="{{ $one->url }}">{{ $one->url }}</a></td>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('admin.footer-col-one.edit', $one->id) }}" class="btn btn-icon" aria-label="Edit">
                                                ...
                                                <a href="{{ route('admin.footer-col-one.destroy', $one->id) }}" class="delete-item btn btn-icon" aria-label="Delete" data-bs-toggle="modal" data-bs-target="#modal-danger">
