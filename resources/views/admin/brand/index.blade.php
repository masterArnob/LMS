                            ...
                            <tbody>
                             ...
                             @forelse ($brands as $brand)
                                    <tr>
                                       ...
                                       <td>   <img src="{{ asset($brand->image) }}" alt="{{ $brand->name }}" class="rounded-circle" width="40" height="40" style="object-fit: cover;"></td>
                                    <td><a href="{{ $brand->url }}">{{ $brand->url }}</a></td>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('admin.brand.edit', $brand->id) }}" class="btn btn-icon" aria-label="Edit">
                                                ...
                                                <a href="{{ route('admin.brand.destroy', $brand->id) }}" class="delete-item btn btn-icon" aria-label="Delete" data-bs-toggle="modal" data-bs-target="#modal-danger">
