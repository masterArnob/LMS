                            ...
                            <tbody>
                             ...
                             @forelse ($requests as $request)
                                    ...
                                    <td>{{ $request->instructor->name }}</td>
                                      <td>{{ $request->payoutGateway->name }}</td>
                                        <td>{{ config('settings.currency_icon') }}{{ $request->amount }}</td>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('admin.payout-request.edit', $request->id) }}" class="btn btn-icon" aria-label="Edit">
